...
public class Controller {
    ...
    public Collection<Javamon> buildJavamon(){
        ...
        Javamon pikachu = new Javamon("Pikachu", pikachuAttacks, 100, "url");
        ...
        List<Attack> charmanderAttacks = Arrays.asList(
                ...
                new Attack("Scratch", AttackType.NORMAL,50,80),
                new Attack("Sand Attack", AttackType.GROUND, 60, 80));
        Javamon charmander = new Javamon("Charmander", charmanderAttacks, 100, "url");
        ...
        List<Attack> squirtleAttacks = Arrays.asList(
                ...
                new Attack("Scratch", AttackType.NORMAL,50,80),
                new Attack("Sand Attack", AttackType.GROUND, 60, 80));
        Javamon squirtle = new Javamon("Squirtle", squirtleAttacks, 100, "url");
        ...
        List<Attack> bulbasaurAttacks = Arrays.asList(
                ...
                new Attack("Sand Attack", AttackType.GROUND, 60, 80));
        Javamon bulbasaur = new Javamon("Bulbasaur", bulbasaurAttacks, 100, "url");
        ...
        List<Attack> geodudeAttacks = Arrays.asList(
                ...
                new Attack("Sand Attack", AttackType.GROUND, 60, 80));
        Javamon geodude = new Javamon("Geodude", geodudeAttacks, 100, "url");
        ...
        Javamon pidgeotto = new Javamon("Pidgeotto", pidgeottoAttacks, 100, "url");
        ...
        Javamon snorlax = new Javamon("Snorlax", snorlaxAttacks, 100, "url");
